...
import (
	...
	"github.com/m-goku/rkt/urlsigner"
)

// UserSignUp displays the login page
func (h *Handlers) UserSignUpPage(w http.ResponseWriter, r *http.Request) {
...
// PostUserSignUp attempts to log a user in
func (h *Handlers) UserSignUp(w http.ResponseWriter, r *http.Request) {
	...
	_, err = h.Models.Users.Insert(data.User{
		FirstName: firstName,
		LastName:  lastName,
		Email:     email,
		Password:  password,
	...
	// w.Write([]byte(strconv.Itoa(user)))
...
func (h *Handlers) UserLoginPage(w http.ResponseWriter, r *http.Request) {
...
func (h *Handlers) Logout(w http.ResponseWriter, r *http.Request) {
	...
	// err := h.App.Render.Page(w, r, "logout", nil, nil)
	// if err != nil {
	// 	h.App.ErrorLog.Println(err)
	// }
...
func (h *Handlers) ForgotPassword(w http.ResponseWriter, r *http.Request) {
	...
	msg := mailer.Message{
		...
		Data:     data,
		From:     "elivation17@gmail.com",
	}

	err = h.App.Mail.Send(msg)
	if err != nil {
		h.App.ErrorLog.Println(err)
		return
	}
...
func (h *Handlers) ResetPasswordFormPage(w http.ResponseWriter, r *http.Request) {
	// get form values
